          ...
          blocks: [
            {
              ...
              items: [
                ...
                'LanguageTool (pt-BR, configurável em Configurações › Geral): ortografia, acentuação, concordância e gramática no documento INTEIRO — capa, Metodologia, legendas, referências e assinaturas incluídas. Só o quadro de busca fica de fora (as queries são sintaxe de busca). Comandos LaTeX, nomes de arquivo, rótulos, dimensões e nomes de modelo (`\\texttt{…}`) são ignorados, assim como títulos em inglês nas referências.',
                'IA opcional (ponto de uso `report_review`): segunda opinião por parágrafo, só nas seções geradas por IA e nas linhas que você editou (comparadas com a versão montada), limitada a concordância e acentuação.',
              ],
            },
            {
              type: 'paragraph',
              text: 'Travas da revisão por IA: a sugestão só é aceita se o trecho existir literalmente e se cada palavra trocada for apenas acento ou flexão de concordância. São recusadas mudanças de tempo verbal ("observa-se" → "observou-se"), de pontuação ou maiúsculas, grafia de Portugal ("respetivamente"), palavras que o dicionário pt-BR não conhece e troca de plural sem motivo. Depois de um número maior que 1, o substantivo fica sempre no plural ("2 publicações").',
            },
            {
              type: 'paragraph',
              text: 'Quando o corretor propõe dividir uma palavra com sufixo duplicado ("comumentemente" → "comumente mente"), a sugestão vira a palavra certa ("comumente"). Nada é alterado sem aprovação: cada sugestão é aplicada ou ignorada individualmente.',
            },
          ],
        },
        {
