...
### Opção 3 — GitHub
Basta dar commit e push neste arquivo — o GitHub renderiza blocos ```mermaid``` automaticamente ao abrir o `.md` no repositório, sem precisar de nenhuma extensão ou ferramenta externa.
